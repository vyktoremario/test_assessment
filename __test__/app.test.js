...
describe("GET /api/post", () => {
  ...
  it("respond with a 400 error for invalid SortBy parameter", async () => {
    const tags = ["history", "politics", "tech"];
    const sortBy = "ran";
    const res = await request(app)
  ...
  it("respond with a 400 error for invalid direction parameter", async () => {
    const tags = ["history", "politics", "tech"];
    const sortBy = "reads";
    const direction = 2;
    const res = await request(app)
  ...
  it("respond with a sorted blog post for various tags based on the direction", async () => {
    const tags = ["history", "politics", "tech"];
    const sortBy = "reads";
